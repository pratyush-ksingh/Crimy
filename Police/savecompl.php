...
$output = array('error' => false);
 ...
 $addrs='';$age=''; $gender='';$convicted='';
            ...
            $age=$_POST['age'];
              ...
              if(empty($_POST['occ']) ){
                array_push($errors,"The Punishment field cannot be empty, ensure is entered");
              }
              else{ 
              $occ=$_POST['occ'];
               }

               if(empty($_POST['convicted']) ){
                array_push($errors,"The convicted field cannot be empty, ensure is entered");
              }
              else{ 
            ...
            $tel=$_POST['tel'];
                ...
                if($errors){
                      ...
                      $output = array('error' => true, $errors);
                         ...
                         $sql = "INSERT INTO complainant (case_id, comp_name, tel, region, district,loc, addrs, age,occupation,gender,convicted,crimetyp)
                                       VALUES(?,?,?,?,?,?,?,?,?,?,?,?); ";

                   $success = $db->insertRow($sql, [$trans_id, $name, $tel, $region, $district, $loc, $addrs, $age, $occ, $gender, $convicted,$crime]);
        ...
        echo json_eJailSuperintendentde($output);
