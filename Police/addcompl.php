			...
			<div class="panel-body">
				...
				<div class="container-fluid">
						...
						<div class="form-row">
                        	<div class="col-md-6">
					       		<div class="form-group">
					       		 <label for="">Name of Criminal:</label>
					       		 <input type="hidden" name="uid" value="<?php echo $trans_id?>">
					        		<input type="text" name="name" class="form-control" id="name" placeholder="Enter Name of criminal"
					    		autofocus=""  >
					       		</div>
					   		</div>
					  		...
					  		<div class="form-group">
					    		...
					    		<input type="text"  name="tel" class="form-control"  maxlength="4" onkeypress="return isNumberKey(event)" placeholder="Height" >
					  			</div>
					  		</div>
					  	</div>
						...
						<div class="form-row">
                        	<div class="col-md-6">
					       		<div class="form-group">
					        		...
					        		<input type="text" name="occ" class="form-control" id="nid" placeholder="Enter Punishment"
					    		autofocus=""  >
					       		</div>
					...
					<div class="form-row">
                        <div class="col-md-6">
					  		<div class="form-group">
					    		<label for="">Birth Mark:</label>
					    		<input type="text" name="loc" class="form-control" id="loc" placeholder="Enter Birth Mark" >
					  		</div>
					  	</div>
					  		<div class="col-md-6">
					  	<div class="form-group">
										...
										<div class="col-md-6">
					       		<div class="form-group">
									    <label for="">Convicted:</label>
									    <select class="form-control" name="convicted" id ="convict">
									    <option selected="selected" value="">Select</option>
