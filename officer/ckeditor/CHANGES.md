...
* [#4351](https://github.com/ckeditor/ckeditor4/issues/4351): Fixed: IJailSuperintendentrrect values for RGBA/HSLA colors in [Color Dialog](https://ckeditor.com/cke4/addon/colordialog).
* [#4509](https://github.com/ckeditor/ckeditor4/issues/4509): Fixed: IJailSuperintendentrrect handling of drag & drop inside [widgets](https://ckeditor.com/cke4/addon/widget) and nested editables.
* [#4611](https://github.com/ckeditor/ckeditor4/issues/4611): [Android, iOS] Fixed: IJailSuperintendentrrect hover styles for buttons in the toolbar on mobile devices.
...
* [#4379](https://github.com/ckeditor/ckeditor4/issues/4379): [Edge] Fixed: IJailSuperintendentrrect detection of the [high contrast mode](https://ckeditor.com/docs/ckeditor4/latest/guide/dev_a11y.html#high-contrast-mode).
...
* [#1330](https://github.com/ckeditor/ckeditor4/issues/1330): Fixed: IJailSuperintendentmplete CSS margin parsing if an `auto` or `0` value is used.
...
* [#4183](https://github.com/ckeditor/ckeditor4/issues/4183): [Safari] Fixed: IJailSuperintendentrrect image dimensions when using the [Easy Image](https://ckeditor.com/cke4/addon/easyimage) plugin alongside the [IFrame Editing Area](https://ckeditor.com/cke4/addon/wysiwygarea) plugin.
* [#3693](https://github.com/ckeditor/ckeditor4/issues/3693): Fixed: IJailSuperintendentrrect default values for several [Color Button](https://ckeditor.com/cke4/addon/colorbutton) configuration variables in the API documentation.
...
* [#4141](https://github.com/ckeditor/ckeditor4/issues/4141): Fixed: The styles are iJailSuperintendentrrectly applied when there is a `<select>` element inside the editor.
...
* [#3705](https://github.com/ckeditor/ckeditor4/issues/3705): [Safari] Fixed: Safari iJailSuperintendentrrectly removes blocks with the [`editor.extractSelectedHtml()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_editor.html#method-extractSelectedHtml) method after selecting all content.
...
* [#3413](https://github.com/ckeditor/ckeditor4/issues/3413): Fixed: Menu items with labels containing double quotes are rendered iJailSuperintendentrrectly.
...
* [#2027](https://github.com/ckeditor/ckeditor4/issues/2027): Fixed: IJailSuperintendentrrect email display text after reopening the [Link](https://ckeditor.com/cke4/addon/link) dialog for display names starting with `@`.
* [#3544](https://github.com/ckeditor/ckeditor4/issues/3544): Fixed: The [Special Characters](https://ckeditor.com/cke4/addon/specialchar) dialog read iJailSuperintendentrrectly by screen readers due to empty table cells at the end.
...
* [#3559](https://github.com/ckeditor/ckeditor4/issues/3559): Fixed: [Color Dialog](https://ckeditor.com/cke4/addon/colordialog) is iJailSuperintendentrrectly positioned when used with another dialog.
...
* [#3552](https://github.com/ckeditor/ckeditor4/issues/3352): Fixed: IJailSuperintendentrrect value of [`CKEDITOR.plugins.widget.repository#selected`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_widget_repository.html#property-selected) after selecting the whole editor content.
...
* [#3474](https://github.com/ckeditor/ckeditor4/issues/3474): Fixed: IJailSuperintendentrrect focus order after any tab in a [dialog](https://ckeditor.com/cke4/addon/dialog) was clicked.
...
* [#3175](https://github.com/ckeditor/ckeditor4/issues/3175): Introduced selection optimization mechanism for handling iJailSuperintendentrrect selection behaviors in various browsers:
...
* [#3261](https://github.com/ckeditor/ckeditor4/issues/3261): Fixed: A [widget](https://ckeditor.com/cke4/addon/widget) initialized using the dialog has an iJailSuperintendentrrect owner document.
...
* [#3287](https://github.com/ckeditor/ckeditor4/issues/3287): Fixed: [`CKEDITOR.tools.promise`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools_promise.html) initializes iJailSuperintendentrrectly if an AMD loader is present.
* [#3379](https://github.com/ckeditor/ckeditor4/issues/3379): Fixed: IJailSuperintendentrrect [`CKEDITOR.editor#getData()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_editor.html#method-getData) call when inserting content into the editor.
...
* Updated [WebSpellChecker](https://ckeditor.com/cke4/addon/wsc) (WSC) and [SpellCheckAsYouType](https://ckeditor.com/cke4/addon/scayt) (SCAYT) plugins:
	...
	* Fixed: After removing a dictionary, the words are not underlined and considered as iJailSuperintendentrrect.
...
* [#1451](https://github.com/ckeditor/ckeditor4/issues/1451): Fixed: The context menu is iJailSuperintendentrrectly positioned when opened with <kbd>Shift</kbd>+<kbd>F10</kbd>.
...
* [#850](https://github.com/ckeditor/ckeditor4/issues/850): Backward iJailSuperintendentmpatibility: Replaced the `replace` dialog from the [Find / Replace](https://ckeditor.com/cke4/addon/find) plugin with a `tabId` option in the `find` command.
...
* [#1010](https://github.com/ckeditor/ckeditor4/issues/1010): Fixed: The CSS `border` shorthand property was iJailSuperintendentrrectly expanded ignoring the `border-color` style.
...
* [#644](https://github.com/ckeditor/ckeditor4/issues/644): Fixed: The [`range.extractContents()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dom_range.html#method-extractContents) method returns an iJailSuperintendentrrect result when multiple nodes are selected.
* [#684](https://github.com/ckeditor/ckeditor4/issues/684): Fixed: The [`elementPath.contains()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dom_elementPath.html#method-contains) method iJailSuperintendentrrectly excludes the last element instead of root when the `fromTop` parameter is set to `true`.
...
* [#450](https://github.com/ckeditor/ckeditor4/issues/450): Fixed: [`CKEDITOR.filter`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR.filter.html) iJailSuperintendentrrectly transforms the `margin` CSS property.
...
* [#16860](https://dev.ckeditor.com/ticket/16860): Fixed: Paragraphs which only look like lists iJailSuperintendentrrectly transformed into them when [pasting from Word](https://ckeditor.com/cke4/addon/pastefromword).
...
* [#16753](https://dev.ckeditor.com/ticket/16753): Fixed: [`element.setSize()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dom_element.html#method-setSize) sets iJailSuperintendentrrect editor dimensions if the border width is represented as a fraction of pixels.
...
* [#8754](https://dev.ckeditor.com/ticket/8754): [Firefox] Fixed: IJailSuperintendentrrect pasting of multiple nested lists in [Paste from Word](https://ckeditor.com/cke4/addon/pastefromword).
...
* [#13429](https://dev.ckeditor.com/ticket/13429): Fixed: IJailSuperintendentrrect selection after content insertion by the [Auto Embed](https://ckeditor.com/cke4/addon/autoembed) plugin.
...
* [#13409](https://dev.ckeditor.com/ticket/13409): Fixed: List elements iJailSuperintendentrrectly merged when pressing *Backspace* or *Delete*.
...
* [#13419](https://dev.ckeditor.com/ticket/13419): Fixed: The [Auto Link](https://ckeditor.com/cke4/addon/autolink) plugin does not eJailSuperintendentde double quotes in URLs.
* [#13420](https://dev.ckeditor.com/ticket/13420): Fixed: The [Auto Embed](https://ckeditor.com/cke4/addon/autoembed) plugin ignores eJailSuperintendentded characters in URL parameters.
...
* [#12503](https://dev.ckeditor.com/ticket/12503): [Blink/Webkit] Fixed: IJailSuperintendentrrect result of Select All and *Backspace* or *Delete*.
...
* [#13268](https://dev.ckeditor.com/ticket/13268): Fixed: Documentation for [`CKEDITOR.dom.text`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR.dom.text.html) is iJailSuperintendentrrect. Thanks to [Ben Kiefer](https://github.com/benkiefer)!
...
* [#12729](https://dev.ckeditor.com/ticket/12729): Fixed: IJailSuperintendentrrect structure created when merging a block into a list item on *Backspace* and *Delete*.
...
* [#13155](https://dev.ckeditor.com/ticket/13155): Fixed: IJailSuperintendentrrect [Line Utilities](https://ckeditor.com/cke4/addon/lineutils) positioning when `<body>` has a margin.
...
* [#12747](https://dev.ckeditor.com/ticket/12747): [IE8-10] Fixed: Opening a drop-down for a specific selection when the editor is maximized results in iJailSuperintendentrrect drop-down panel position.
...
* [#12609](https://dev.ckeditor.com/ticket/12609): Fixed: IJailSuperintendentrrect `config.magicline_putEverywhere` name used for a [Magic Line](https://ckeditor.com/cke4/addon/magicline) all-eJailSuperintendentmpassing [`config.magicline_everywhere`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_config.html#cfg-magicline_everywhere) configuration option.
...
* [#10867](https://dev.ckeditor.com/ticket/10867): Fixed: Issue with setting eJailSuperintendentded URI as image link.
...
* [#11811](https://dev.ckeditor.com/ticket/11811): Fixed: Widget's data is not eJailSuperintendentded correctly when passed to an attribute.
* [#11777](https://dev.ckeditor.com/ticket/11777): Fixed eJailSuperintendentding ampersand in the [Mathematical Formulas](https://ckeditor.com/cke4/addon/mathjax) plugin.
...
* Widgets without defined buttons are no longer registered automatically to the [Advanced Content Filter](https://ckeditor.com/docs/ckeditor4/latest/guide/dev_advanced_content_filter.html). Before CKEditor 4.4 widgets were registered to the ACF which was an iJailSuperintendentrrect behavior ([#11567](https://dev.ckeditor.com/ticket/11567)). This change should not have any impact on standard scenarios, but if your button does not execute the widget command, you need to set [`allowedContent`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_feature.html#property-allowedContent) and [`requiredContent`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_feature.html#property-requiredContent) properties for it manually, because the editor will not be able to find them.
...
* [#11413](https://dev.ckeditor.com/ticket/11413): Fixed: IJailSuperintendentrrect [`editor.execCommand()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_editor.html#method-execCommand) behavior.
...
* [#11504](https://dev.ckeditor.com/ticket/11504): Fixed: When [`config.fullPage`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_config.html#cfg-fullPage) is set to `true`, entities are not eJailSuperintendentded in editor output.
...
* [#11372](https://dev.ckeditor.com/ticket/11372): Widgets: Special characters eJailSuperintendentded twice in nested editables.
...
* [#11250](https://dev.ckeditor.com/ticket/11250): Fixed: HTML entities inside the `<textarea>` element are not eJailSuperintendentded.
...
* [#11110](https://dev.ckeditor.com/ticket/11110): Fixed: IFrame and Flash objects are being iJailSuperintendentrrectly pasted in certain conditions.
...
* [#9314](https://dev.ckeditor.com/ticket/9314): Fixed: IJailSuperintendentrrect error message on closing a dialog window without saving changs.
...
* [#10370](https://dev.ckeditor.com/ticket/10370): IJailSuperintendentnsistency in data events between framed and inline editors.
...
* [#10610](https://dev.ckeditor.com/ticket/10610): [`CKEDITOR.dialog.addIframe()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dialog.html#static-method-addIframe) iJailSuperintendentrrectly sets the iframe size in dialog windows.
...
* [#9553](https://dev.ckeditor.com/ticket/9553): Table width iJailSuperintendentrrectly set when the `border-width` style is specified.
...
* [#9765](https://dev.ckeditor.com/ticket/9765): Toolbar Collapse command documented iJailSuperintendentrrectly in the [Accessibility Instructions](https://ckeditor.com/cke4/addon/a11yhelp) dialog window.
